...
public class ApiController {
    ...
    @ResponseBody()
    @ResponseStatus(HttpStatus.CREATED)
    @PostMapping(value = "/add-recipes")
    public void addNewRecipes(@RequestParam Long userId,
                              @RequestBody List<RecipeValueObject> myRecipes) {
        userService.addToMyRecipes(userId, myRecipes);
    }
